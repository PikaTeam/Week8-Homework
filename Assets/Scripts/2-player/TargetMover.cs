...
public class TargetMover: MonoBehaviour {
    ...
    private IWeightedGraph<Vector3Int> tilemapGraph = null;
    private float timeBetweenSteps;

    protected virtual void Start() {
        tilemapGraph = new TilemapWeightedGraph(tilemap, allowedTiles);
    ...
    private void MakeOneStepTowardsTheTarget() {
        ...
        List<Vector3Int> shortestPath = AStar.GetPath(tilemapGraph, startNode, endNode, heuristicDistance, maxIterations);
    ...
    private float GetNewTimeBetweenSteps(TileBase currentlyOnTile)
    {
         return 1/(speed * 1/allowedTiles.GetWeightOf(currentlyOnTile));
    }

    private static float heuristicDistance(Vector3Int startNode, Vector3Int endNode)
    {
